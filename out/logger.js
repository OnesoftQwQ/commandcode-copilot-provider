...
class Logger {
     ...
     */
    init() {
        this._outputChannel = vscode.window.createOutputChannel("CommandCode", { log: true });
    }
    debug(tag, data) {
    ...
    sanitizeHeaders(headers) {
        ...
        for (const [key, value] of Object.entries(headers)) {
            const isSensitive = SENSITIVE_HEADER_KEYS.some((k) => key.toLowerCase() === k.toLowerCase());
