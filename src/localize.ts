...
"Failed to generate commit message:": "生成提交消息失败：",
	...
	// Timeout error
	"Request timed out. The generation took too long. You can increase the timeout in settings (commandcode.requestTimeout).":
		"请求超时，生成内容过长。您可以在设置中增加超时时间（commandcode.requestTimeout）。",
